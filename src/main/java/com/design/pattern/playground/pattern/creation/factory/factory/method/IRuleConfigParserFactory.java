package com.design.pattern.playground.pattern.creation.factory.factory.method;

import java.util.HashMap;

/**
 * @author <a href="mailto:luojianwei@pinming.cn">LuoJianwei</a>
 * @since 2020/8/8 12:39
 */
// 在 RuleConfigParserFactory 的第一种代码实现中，有一组 if 分支判断逻辑，
// 是不是应该用多态或其他设计模式来替代呢？实
// 际上，如果 if 分支并不是很多，代码中有 if 分支也是完全可以接受的。
...
// 这就是工厂方法模式的典型代码实现。这样当我们新增一种 parser 的时候，
